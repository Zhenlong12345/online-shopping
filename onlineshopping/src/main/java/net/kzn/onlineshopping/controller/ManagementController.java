...
public class ManagementController {
	...
	public String handleProductsSubmission(@Valid @ModelAttribute("product") Product mProduct,BindingResult results,Model model,
	...
	@RequestMapping(value="/product/{id}/activation",method=RequestMethod.POST)  //match the activationUrl in myapp.js
	@ResponseBody  //Automate convert the data into json
